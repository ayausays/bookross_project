...
public interface BuddylistRepository extends  JpaRepository<BuddyList,Long> {
    @Query(
            value = "select new com.bookross.mainservice.demo.entity.response.BuddyListGetResources(b.id,b.senderId,b.isRead,b.link,b.createdAt,b.updatedAt,u.firstName,u.lastName, u.photo)" +
